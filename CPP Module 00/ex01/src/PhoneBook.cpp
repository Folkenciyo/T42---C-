...
void	PhoneBook::set_information(void)
{
	...
	{
		std::cout << "Your phonebook is full.\nIf you want to add a new contact, I would have to delete the first contact I had store, index #1." << std::endl;
...
void	PhoneBook::get_information() const
{
	...
	else
	{
		...
		if (index > 0)
		{
			...
			std::cout << "\033[32m|\033[0m \033[33mIndex\033[0m \033[32m|\033[0m \033[33mFirst Name\033[0m \033[32m|\033[0m \033[33mLast Name\033[0m \033[32m|\033[0m \033[33mNickname\033[0m \033[32m|\033[0m" << std::endl;
			std::cout << "\033[32m|-------|------------|-----------|----------|\033[0m" << std::endl;
...
{
    std::cout << std::endl << "\033[34mWelcome to the phonebook!" << std::endl;
